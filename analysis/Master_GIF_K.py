#####################################################
#   Master_GIF_K.py
#   Process all neurons and extract GIF-K parameters.
#   Output files:
#       (1) CellName_GIF_K_Raster.png : Raster of GIF-K model vs experiments
#       (2) CellName_GIF_K_FitPerformance.dat : Md* Epsilon_V(test) PVar for cell CellName
#       (3) GIF_K_FitPerformance.dat : Md* Epsilon_V(test) for all cells
#       (4) CellName_GIF_K_ModelParams.pck : Model parameters and filters
...
if __name__ == "__main__":
    process_all_files_for_GIF_K(is_E_K_fixed=True)
